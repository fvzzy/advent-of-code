...
export function updateSolutionsIndex(year, day) {
  ...
  const newImportLine = `import { problem${year}_${day}_1, problem${year}_${day}_2, title as title${year}_${day} } from "../dist/${year}/${dayPadded(
    day
  )}.js";`;
  const newExportLine = `"${year}_${day}": { problem1: problem${year}_${day}_1, problem2: problem${year}_${day}_2, title: title${year}_${day} },`;
